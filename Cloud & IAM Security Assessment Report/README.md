...
*Evidence: [02-raynor-caller-identity.png](screenshots/02-raynor-caller-identity.png) (authenticated as the limited user), [04-attached-policy-list.png](screenshots/04-attached-policy-list.png) (policy discovered), [05-policy-versions-list.png](screenshots/05-policy-versions-list.png) (v1–v5 listed, v1 default), [06-policy-version-inspect.png](screenshots/06-policy-version-inspect.png) (v3 showing full admin access)*
...
*Evidence: [03-access-denied-before.png](screenshots/03-access-denied-before.png) (denied before escalation), [07-set-default-policy-version.png](screenshots/07-set-default-policy-version.png) (rollback command executed), [08-access-granted-after.png](screenshots/08-access-granted-after.png) and [08b-access-granted-after-iam-create.png](screenshots/08b-access-granted-after-iam-create.png) (access confirmed after escalation)*
...
*Evidence: [10-bucket-block-public-access-disabled.png](screenshots/10-bucket-block-public-access-disabled.png) (public access unblocked), [11-bucket-policy-public.png](screenshots/11-bucket-policy-public.png) (public policy applied), [12-bucket-object-public-url-accessible.png](screenshots/12-bucket-object-public-url-accessible.png) (object loading with no login)*
...
*Evidence: [13-bucket-remediated-block-public-access-enabled.png](screenshots/13-bucket-remediated-block-public-access-enabled.png) (Block Public Access re-enabled), [14-bucket-object-url-blocked-after-fix.png](screenshots/14-bucket-object-url-blocked-after-fix.png) (same URL now returning Access Denied)*
...
*Deployment and teardown evidence: [01-cloudgoat-create-output.png](screenshots/01-cloudgoat-create-output.png) (scenario deployed), [09-cloudgoat-destroy-output.png](screenshots/09-cloudgoat-destroy-output.png) (scenario destroyed, no errors)*
