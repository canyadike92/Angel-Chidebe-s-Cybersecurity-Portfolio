...
[Lab Topology →](screenshots/phase0-01-lab-topology.png)
...
[Static IP →](screenshots/phase2-01-static-ip-confirmed.png)
[AD DS Installed →](screenshots/phase3-01-adds-installed.png)
...
[Domain Join →](screenshots/phase4-01-domain-join-success.png)
...
[Test Accounts →](screenshots/phase5-01-test-accounts-created.png)
...
[Logs Flowing →](screenshots/phase6-03-logs-flowing-confirmed.png)
...
[Attack Results →](screenshots/phase7-02-password-spray-full-results.png)
...
[Detection Triggered →](screenshots/phase8-02-detection-search-triggered.png)
...
[Alert Configured →](screenshots/phase8-03-alert-configured.png)
